        ...
        var c = {
            ...
            computePositionStyle: function (a, b) {
                ...
                if (c.settings.transformsSupported) {
                    var f = a && "right" == c.options.direction ? "-" : "", g = "translate3d(" + f + d + ",0,0)", h = "transform";
            ...
            setjPanelMenuStyles: function () {
                var b = "background:#fff", d = a("html").css("background-color"), e = a("body").css("background-color"), f = function (b) {
                    var c = [];
